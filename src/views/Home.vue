...
<template>
  <div class="bg-site-bg text-ink-base antialiased">
    ...
    >
          ...
          <div class="w-full mx-auto px-2 md:px-6 py-4 flex justify-center">
            ...
            >
              <li class="menu-item text-right">
                <a href="#about">
                  <span
                    class="block font-mini_titre md:text-lg text-sm text-center"
                    >À propos</span
                  >
                  <em
                    class="block italic font-cormorant md:text-lg text-md text-center"
                    >bio</em
                  >
                </a>
              </li>
      ...
      <div class="relative z-10 h-full grid place-items-center">
        <div class="text-center text-white">
          <h1
            class="reveal reveal--fade-up font-titre tracking-[32px] text-6xl md:text-[128px] leading-none drop-shadow"
          >
            CRUMBLE
          </h1>
          <p
            class="reveal reveal--fade-up mt-4 font-cormorant italic text-lg md:text-[34px] tracking-wideish opacity-90"
          >
            photographe
          </p>
        </div>
    ...
    <section
      id="about"
      class="pt-10 xl:mx-64 lg:mx-24 mx-3 reveal reveal--fade-up"
    >
      <div class="w-full text-center flex flex-col gap-8">
        ...
        <Card size="w-full">
          <div class="w-full lg:w-1/2 flex flex-col gap-6 self-center text-lg">
            <p>
              Je pratique la photographie de portrait depuis maintenant 10 ans.
              Vous trouverez sur ce site un bref exposé du travail effectué
              durant toutes ces années.
            </p>
            <p>
              En 2020, je me suis prise de passion pour Valorant, le jeu qui m'a
              ouvert les portes de l'Esport. Éprise de ce nouvel univers, j'ai
              décidé d'allier mes deux passions, de mettre mes compétences au
              service de la scène et d'y planter ma graine.
            </p>
          </div>
    ...
    <section
      id="portfolio"
      class="xl:mx-64 lg:mx-24 mx-3 reveal reveal--fade-up"
    >
      <div class="w-full text-center flex flex-col gap-8">
        <div>
          <h2 class="font-mini_titre text-5xl text-ink-base">Portfolio</h2>
          <p class="font-serif italic text-ink-base">
        ...
        <Card size="w-full grid grid-cols-2 p-3 gap-3 md:gap-10 md:p-10">
          <CardPortfolio
            ...
            name="PORTRAIT"
            imgSrc="/images/portrait/51a00d_c2d37f7075a846798b32ffaedf9ee6a9~mv2.jpeg"
          />
          <CardPortfolio
            class="reveal reveal--fade-in"
            name="ESPORT"
            imgSrc="/images/esport/51a00d_ea1161ad4be14d37a393c2ff809a0bf4~mv2.jpeg"
          />
        </Card>
      </div>
    </section>
    ...
    <section id="shop" class="xl:mx-64 lg:mx-24 mx-3 reveal reveal--fade-up">
      <div class="w-full text-center flex flex-col gap-8">
        ...
        <div
          class="flex flex-col gap-8 md:flex-row md:flex-wrap md:gap-6 lg:flex-nowrap lg:gap-10 justify-between"
        >
          <div class="w-full md:w-[48%] lg:w-1/3 flex">
            <Card
              size="w-full flex flex-col text-ink-base gap-6 reveal reveal--scale-in"
            >
              ...
              <div class="flex flex-col gap-4 font-helvetica">
                <p>
                  <b>45 minutes</b> à <b>1h</b> de shooting en extérieur ou à
                  domicile
                </p>
                <p>Choix de <b>5 photos</b> via une galerie privée</p>
                <p>
                  Rendu des photos retouchées sous format numérique
                  <b>1 semaine</b> à <b>2 semaines</b> après le shooting.
                </p>
                <div
                  class="border-t-2 border-ink-mute my-6 w-1/2 mx-auto"
                ></div>
                <p class="text-sm">
                  Parfaite pour les premières expériences ou les petits budgets
                </p>
              </div>
            </Card>
          </div>
          <div class="w-full md:w-[48%] lg:w-1/3 flex">
            ...
            >
              ...
              <div class="flex flex-col gap-4 font-helvetica">
                ...
                ></div>
                <p class="text-sm">
                  Idéale pour les couples, les amis, les diplômes, ...
                </p>
              </div>
            </Card>
          </div>
          <div class="w-full md:w-full lg:w-1/3 flex">
            ...
            >
              ...
              <div class="flex flex-col gap-4 font-helvetica">
                <p>
                  <b>2h</b> à <b>2h30</b> de shooting en extérieur et/ou à
                  domicile, <b>2 lieux de shooting</b>
                </p>
                <p>Choix de <b>20 photos</b> via une galerie privée</p>
                <p>
                  Rendu des photos retouchées sous format numérique
                  <b>2 semaines</b> après le shooting.
                </p>
                <div
                  class="border-t-2 border-ink-mute my-6 w-1/2 mx-auto"
                ></div>
                <p class="text-sm">
                  Conçu pour les moments les plus mémorables de la vie :
                  fiançailles, nouveau-nés, séances en famille.
                </p>
              </div>
            </Card>
          </div>
    ...
    <section id="contact" class="xl:mx-64 lg:mx-24 mx-3 reveal reveal--fade-up">
      <div class="w-full text-center flex flex-col gap-8">
        ...
        <form
          class="bg-[#EAE6F6] rounded-lg p-8 shadow-lg flex flex-col gap-6"
          method="POST"
          action="/"
        ...
        >
          ...
          <div class="flex flex-col md:flex-row gap-6">
            <div class="flex flex-col gap-6 w-full md:w-1/2">
              <div class="flex flex-row flex-wrap gap-6 w-full">
                <div class="w-full flex flex-col gap-2">
                  <label
                    for="prenom"
                    class="text-left font-medium text-ink-base"
                    >Prénom *</label
                  >
                  <input
                    id="prenom"
                ...
                <div class="w-full flex flex-col gap-2">
                  <label for="nom" class="text-left font-medium text-ink-base"
                    >Nom *</label
                  >
                  <input
                    id="nom"
              ...
              <div class="flex flex-col gap-2">
                <label for="email" class="text-left font-medium text-ink-base"
                  >Email *</label
                >
                <input
                  id="email"
              ...
              <div class="flex flex-col gap-2">
                <label for="demande" class="text-left font-medium text-ink-base"
                  >Demande *</label
                >
                <select
                  id="demande"
            ...
            <div class="flex-1 flex flex-col gap-2 w-full md:w-1/2">
              <label for="envies" class="text-left font-medium text-ink-base"
                >Vos envies et besoins pour ce shooting *</label
              >
              <textarea
                id="envies"
                name="envies"
                required
                rows="6"
                class="rounded-md border border-[#CDBFE0] h-full px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#CDBFE0] bg-white resize-none"
              ></textarea>
            </div>
          </div>
          <p class="text-left text-sm text-ink-mute mt-2">
            * Attention, une séance photo n’est définitivement réservée qu’après
            retour et confirmation de ma part.
          </p>
